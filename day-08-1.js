/*--------------------------
  ...
  Solution explanation: 
     I just count the number or outputs that are inuque
---------------------------*/
...
console.info(inputs.reduce((c, input) => c + input[1].split(" ").reduce((c2, x) => c2 + ([2,3,4,7].indexOf(x.length) > -1 ? 1 : 0), 0), 0));

//The right answer is: 321
