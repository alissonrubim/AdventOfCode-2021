...
function getFirstWinnerBoad(boards, numbers){
  var winner =  null;
  var last = -1;
  numbers.some((n) => {
    last = n;
  ...
  var total = winner.reduce((c, n) => c + n.reduce((c2, n2) => c2 + (n2 > 0 ? n2 : 0), 0), 0)
  console.info(total, winner)
...
getFirstWinnerBoad(boards, numbers);